            ...
            $html .= '
                <div class="col-lg-4 col-md-6 portfolio-item filter-level' . $level_key . '">
                    <div class="portfolio-wrap">
                        <img src="assets/img/programs/program-' . $program_key . '.jpg" class="img-fluid" alt="">
                        <div class="portfolio-links">
                        <a href="assets/img/programs/program-' . $program_key . '.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="'.$title.'"><i class="bx bx-info-circle"></i></a>
